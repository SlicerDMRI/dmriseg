...
# Folds
group_names=("dcn" "dentate" "interposed" "fastigial")
...
out_dirname=/mnt/data/cerebellum_parc/experiments_minimal_pipeline/${contrast_folder_label}/aggregate_performance/ismrm
