...
out_fname=${out_root_dirname}/${out_gnd_th_folder_label}/ismrm/${_sub_id}__${gnd_th_bckgnd_contrast_label}_${view_name}_gnd_th_seg.png
...
out_fname=${out_root_dirname}/${out_folder_label}/ismrm/${_sub_id}__${file_basename_label}_${view_name}.png
...
out_fname=${out_root_dirname}/${out_folder_label}/ismrm/${_sub_id}__${file_basename_label}_${view_name}_pred_seg.png
