...
# Folds
group_names=("anterior_lobe" "posterior_lobe")
...
out_dirname=/mnt/data/cerebellum_parc/experiments_minimal_pipeline/${contrast_folder_label}/aggregate_performance/lobes
